...
val ALPHABET_CHARACTERS = charArrayOf(
...
fun String.equalsEx(des: String): Boolean{
    val srcSlug = this.toSlug()
    val desSlug = des.toSlug()
    return srcSlug == desSlug
}

fun String.containEx(des: String): Boolean {
    val srcSlug = this.toSlug()
    val desSlug = des.toSlug()
    return srcSlug.contains(desSlug)
}